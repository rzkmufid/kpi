...
<div class="container mt-4">
  <h4>Tambah KPI</h4>
  <form action="insert_kpi.php" method="POST">
    <div class="mb-3">
    ...
    <div class="mb-3"><label>KPI</label><input type="text" name="kpi" class="form-control" placeholder="Masukkan KPI" required></div>
    <div class="mb-3"><label>Jenis Hasil</label><input type="text" name="jenis_hasil" class="form-control" placeholder="Masukkan Jenis Hasil"></div>
    <div class="mb-3">
      <label>Jumlah Dokumen</label>
      <div class="input-group">
        <input type="number" name="jumlah_dokumen" class="form-control" placeholder="Jumlah Dokumen" required>
        <input type="text" name="satuan_dokumen" class="form-control" placeholder="Satuan">
      </div>
    </div>
...
<div class="modal fade" id="modalTambahJabatan" tabindex="-1">
  <div class="modal-dialog">
    <form action="insert_jabatan.php" method="POST" class="modal-content">
